...
macro(add_qt_windows_exe TARGET)
    ...
    cmake_parse_arguments(ARG "NAME;DEPLOY_NAME;INSTALLER_NAME;VERSION;PUBLISHER;PRODUCT_URL;PACKAGE;"
    	"FILE_EXTENSION;ICON;ICON_RC;DEPENDS;QML_DIR;ALL;"
    	"NO_DEPLOY;NO_INSTALLER;NO_TRANSLATION;VERBOSE_LEVEL_DEPLOY;VERBOSE_INSTALLER" ${ARGN})

    SET_TARGET_PROPERTIES(${TARGET} PROPERTIES WIN32)
    IF(ARG_ICON_RC)
